...
namespace FormsPlugin.FontIcons
{
	...
	/// See https://montemagno.com/using-font-icons-in-xamarin-forms-goodbye-images-hello-fonts/
	/// </summary>
	public static class FontAwesome5FreeSolid
	{
		/// <summary>
		/// Font family, only for iOS or Android
		/// </summary>
